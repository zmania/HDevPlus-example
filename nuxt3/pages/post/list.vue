...
const requestData = {'dataID': 'GET_POST_LIST', 'list_per_page': 10, 'page_link_url': '/post/list', 'search_keyword': route.query.search_keyword, 'page': route.query.page};
    ...
    <div class="row g-5">
      <div class="col-12">
        ...
        <div class="py-2 d-flex justify-content-between align-items-center">
          ...
          <NuxtLink :href="output.user.auth_flg ? '/post/add' : '/member/login'" class="btn btn-sm btn-dark d-flex justify-content-between align-items-center lh-1"><small class="smaller">ADD</small></NuxtLink>
        </div>
