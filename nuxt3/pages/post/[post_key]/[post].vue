...
const requestData = {
  'dataID': 'GET_POST',
  'post_key': route.params.post_key,
  'page_link_url': '/post/' + route.params.post_key + '/' + route.params.post,
                ...
                <div class="col-12">
                  <div class="d-flex justify-content-between align-items-center py-3 border-bottom">
                    ...
                    <div class="d-flex justify-content-between align-items-center"
                         v-if="output.user.auth_flg && output.post[0].member_seq == output.user.seq">
                      <NuxtLink :href="'/post/modify?post_key='+output.post[0].post_key"
                                class="mx-1 btn btn-dark d-flex justify-content-between align-items-center lh-1"><small
                          class="smaller d-none d-md-block">수정</small></NuxtLink>
                      <NuxtLink href="#" data-return-url="./list" :data-post-key="output.post[0].post_key"
                                class="h-btn-delete mx-1 btn btn-dark d-flex justify-content-between align-items-center lh-1">
                        <small class="smaller d-none d-md-block">삭제</small></NuxtLink>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="d-flex align-items-center justify-content-start my-2">
                      <span v-for="tags in output.post[0].tags"
          ...
          <div id="section_comment" class="hash-link">
            <div class="comment mt-5 me-3">
              ...
              <form id="frm_comment" class="my-4">
                <div class="d-flex justify-content-between align-items-baseline"><h4>댓글</h4><small>댓글 <span
                    class="comment-count">{{ output.post[0].comment_count.toLocaleString() }}</span>개</small></div>
                <div class="py-4 border-0 border-top border-bottom">
                  <div class="input-group mb-0" v-if="output.user.auth_flg">
                    ...
                    <textarea id="comment" type="text" rows="1" class="form-control" name="comment"
                              placeholder="댓글을 입력하세요" style="height: 40.8px;"></textarea>
                  ...
                  <div class="input-group mb-0" v-else>
                    ...
                    <NuxtLink class="btn border-hbnc-primary bg-hanbnc-primary-3 border border-3 rounded-0"
                              href="../member/login.html">로그인
                    </NuxtLink>
                  </div>
                </div>
              </form>
            ...
            <div class="me-3">
                ...
                <div class="pb-4 order-0">
                  <div class="comment-list">
                    <div class="h-div-comment" :data-comment-key="comment.comment_key"
                         v-for="(comment, index) in output.post[0].comment_list" :key="comment.comment_key">
                      <div class="border-bottom px-1 py-3 position-relative post-comment-item">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          <NuxtLink href="#" class="h-btn-show-reply-comment" v-if="comment.reply_comment.length>0">
                            <small>답글 {{ comment.reply_comment_cnt.toLocaleString() }}개 보기</small></NuxtLink>
                          <span v-else>&nbsp;</span>
                          <div class="d-flex justify-content-between align-items-center">
                            <NuxtLink v-if="output.user.auth_flg && comment.member_seq == output.user.seq" href="#"
                                      class="h-btn-reply-modify btn btn-outline-dark btn-sm ms-2 my-2 small">수정
                            </NuxtLink>
                            <NuxtLink v-if="output.user.auth_flg && comment.member_seq == output.user.seq" href="#"
                                      class="h-btn-reply-delete btn btn-outline-dark btn-sm ms-2 my-2 small">삭제
                            </NuxtLink>
                            <NuxtLink href="#" class="h-btn-reply-comment btn btn-outline-dark btn-sm ms-2 my-2 small">
                              답글
                            </NuxtLink>
                          </div>
                        </div>
                        <form class="my-3 h-form-reply-comment" style="display:none;">
                          ...
                          <div class="mb-0 mt-2">
                            <textarea type="text" rows="1" class="form-control comment-textarea" name="comment"
                                      placeholder="답글을 입력하세요" style="height: 42px;"></textarea>
                          </div>
                            ...
                            <div class="py-3 border-top position-relative">
                              <div class="comment-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                  ...
                                  <div>
                                    <NuxtLink v-if="output.user.auth_flg && reply_comment.member_seq == output.user.seq"
                                              href="#"
                                              class="h-btn-reply-modify d-inline-block btn btn-outline-dark btn-sm ms-2 my-2 small">
                                      <i class="fas fa-user-edit"></i> 수정
                                    </NuxtLink>
                                    <NuxtLink v-if="output.user.auth_flg && reply_comment.member_seq == output.user.seq"
                                              href="#"
                                              class="h-btn-reply-delete d-inline-block btn btn-outline-dark btn-sm ms-2 my-2 small">
                                      <i class="fas fa-trash-alt"></i> 삭제
                                    </NuxtLink>
                                    <NuxtLink href="#"
                                              class="h-btn-reply-comment btn-outline-secondary d-inline-block btn btn-outline-dark btn-sm ms-2 my-2 small">
              ...
              <div class="text-center">
                <NuxtLink
                    :href="'/post/list?pae='+(route.query.page?route.query.page:'')+'&search_keyword='+(route.query.search_keyword?route.query.search_keyword:'')"
                    class="btn btn-outline-dark">목록으로
                </NuxtLink>
              </div>
            </div>
          </div>
